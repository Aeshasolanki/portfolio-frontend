      ...
      <div className="relative z-10 max-w-6xl mx-auto grid md:grid-cols-2 gap-16 items-center">
        ...
        >
          ...
          <p className="text-zinc-300 text-lg max-w-xl">
            Having 35+ finance related calculations in one powerful app
          </p>

          <p className="text-zinc-400 leading-relaxed max-w-xl">
            Finance Calculator helps users calculate loans, mortgages,
            investments, taxes, and savings with speed and accuracy.
          </p>

          <p className="text-zinc-400 leading-relaxed max-w-xl">
            Ideal for individuals, professionals, and small businesses who
            want a complete financial toolkit.
          </p>
          ...
          <div className="pt-8">
            <a
              href="https://apps.apple.com/us/app/emi-loan-calculator-planner/id1536760394"
              target="_blank"
        ...
        >
          <motion.img
            src="/finance.png"
            alt="Finance Calculator App Icon"
            animate={{ y: [0, -14, 0] }}
