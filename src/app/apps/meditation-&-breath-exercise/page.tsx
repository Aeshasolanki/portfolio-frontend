      ...
      <div className="relative z-10 max-w-6xl mx-auto grid md:grid-cols-2 gap-16 items-center">
        ...
        >
          ...
          <h1 className="text-4xl md:text-6xl font-black leading-tight">
            Meditation & <span className="text-blue-400">Breath Exercise</span>
          </h1>

          <p className="text-zinc-300 text-lg max-w-xl">
            Meditation programs & various breathing exercises for mental well-being.
          </p>

          <p className="text-zinc-400 leading-relaxed max-w-xl">
            Guided meditation and breathing exercises to reduce stress, improve focus, and enhance mental clarity.
          </p>

          <p className="text-zinc-400 leading-relaxed max-w-xl">
            Ideal for beginners and advanced users, with customizable sessions, reminders, and progress tracking.
          </p>
          ...
          <div className="pt-6">
            ...
            <div className="flex flex-wrap gap-3">
              {["React Native", "Firebase", "Expo", "Calm API"].map((tech, i) => (
                <motion.span
                  key={i}
          ...
          <div className="pt-8">
            <a
              href="https://apps.apple.com/in/app/mindful-breathe-sleep-calm/id1489689443"
              target="_blank"
        ...
        >
          <motion.img
            src="/meda.png"
            alt="Meditation & Breath Exercise Icon"
            animate={{ y: [0, -14, 0] }}
