      ...
      <div className="relative z-10 max-w-6xl mx-auto grid md:grid-cols-2 gap-16 items-center">
        ...
        >
          ...
          <h1 className="text-4xl md:text-6xl font-black leading-tight">
            Lenten <span className="text-blue-400">Pilgrimage</span>
          </h1>

          <p className="text-zinc-300 text-lg max-w-xl">
            Track your pilgrimage progress as you travel
          </p>

          <p className="text-zinc-400 leading-relaxed max-w-xl">
            Lenten Pilgrimage helps you track your spiritual journey with milestones, daily reflections, and inspirational guidance.
          </p>

          <p className="text-zinc-400 leading-relaxed max-w-xl">
            Perfect for pilgrims and travelers who want to stay mindful, motivated, and spiritually connected throughout their journey.
          </p>
          ...
          <div className="pt-6">
            ...
            <div className="flex flex-wrap gap-3">
              {["React Native", "Firebase", "Node.js", "Expo"].map((tech, i) => (
                <motion.span
                  key={i}
          ...
          <div className="pt-8">
            <a
              href="https://apps.apple.com/us/app/lenten-pilgrimage/id6476985611"
              target="_blank"
        ...
        >
          <motion.img
            src="/lif.png"
            alt="Lenten Pilgrimage App Icon"
            animate={{ y: [0, -14, 0] }}
